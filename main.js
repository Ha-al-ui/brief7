...
function Book(title, author, pages, language, type, date, email, readStatus,) {
	this.title = title;
	this.author = author;
	this.pages = pages;
...
function addBookToLibrary(title, author, pages, language, type, date, email, readStatus,) {
	let newBook = new Book(title, author, pages, language, type, date, email, readStatus,);
...
function submitForm() {
	...
	let type = document.getElementById('book-type').value;
	...
	addBookToLibrary(title, author, pages, language, type, date, email, readStatus);
			...
			<div class="card">
				<div class="card-body">
					...
					<ul>
                        ...
                        <li>Language: ${myLibrary[i].language}</li>
						<li>Type: ${myLibrary[i].type}</li>
						<li>Date: ${myLibrary[i].date}</li>
						<li>Email Author: ${myLibrary[i].email}</li>
